...
/* HashTable2.java
   ...
   You should complete this file with the implementation for part 2.
...
public class HashTable2{
	...
	*/
		...
		for(int i=0;i<s.length();i++){
			...
			count+=((long)s.charAt(i))*2^i;
		}
		return (int)count%TableSize;
	}
	...
	*/
	public int insert(String s){
		...
		long i = (long)hash(s);
        long j= 0;
		//Use quadratic probing for collision resolution probing to find an empty slot.
	...
	*/
	public int find(String s){
		...
		long i = (long)hash(s);
        long j = 0;
		//Use quadratic probing to find the string.
		while (true){
